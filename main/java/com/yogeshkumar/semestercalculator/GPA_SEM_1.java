...
public class GPA_SEM_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gpa_sem1);
        ...
        btnCalGPA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (et_sub1.getText().toString().isEmpty() || et_sub2.getText().toString().isEmpty() ||
                        et_sub3.getText().toString().isEmpty() || et_sub4.getText().toString().isEmpty() ||
                        et_sub5.getText().toString().isEmpty() || et_sub6.getText().toString().isEmpty() ||
                        et_sub7.getText().toString().isEmpty() || et_sub8.getText().toString().isEmpty())
                {
                    Toast.makeText(GPA_SEM_1.this, "Enter all Semester Grade Points", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    Intent intent = new Intent(GPA_SEM_1.this, GPA_RESULT.class);
